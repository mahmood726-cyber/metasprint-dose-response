        # Metasprint Dose Response: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metasprint-dose-response.git

        ## Objective

        MetaSprint Dose Response extends the MetaSprint autopilot to dose-response meta-analysis, supporting flexible spline and parametric models.
        ...
        - Code: https://github.com/mahmood726-cyber/metasprint-dose-response.git
        - Dashboard: https://mahmood726-cyber.github.io/metasprint-dose-response/
